  ...
  group('VideoEvent Multiple Imeta Parsing (Postel\'s Law)', () {
    test('selects best URL from multiple imeta tags with broken and working URLs', () {
      ...
      final event = Event.fromJson({
        'id': '8bd52c7beac0e08691178089750de8cba8666b7ca1b40267bd8d17546f00064a',
        'pubkey': 'f877b0f7850c752d0aabd3083f1b2db3177334efd087302bc2116d988759d919',
        'created_at': 1760376721,
        'kind': 34236,
        'content': '161015 bundang fansign ✧ YOONGI FOCUS',
        'sig': 'fa9390f525b7be8f18c2f7e1f9cf2e179b7b8756714089423969ab584d4428c7f356ce77706b15b9699bc7af9f77648118184fcbe84fa349f9b09b6ae01a8dca',
        'tags': [
          ['d', '5dBOuO66YtA'],
          // First imeta - has working MP4 and HLS URLs
          [
            'imeta',
            'url', 'https://cdn.divine.video/4b38e80d2567d290f91268202e9a9d89f29fdae29b89aec9df3b7c8ac9e290b2.mp4',
            'm', 'video/mp4',
            'x', '4b38e80d2567d290f91268202e9a9d89f29fdae29b89aec9df3b7c8ac9e290b2',
            'image', 'https://stream.divine.video/9f507ce3-fc05-4e1f-a6b7-5d5270769420/thumbnail.jpg',
            'hls', 'https://stream.divine.video/9f507ce3-fc05-4e1f-a6b7-5d5270769420/playlist.m3u8',
          ],
          // Second imeta - has BROKEN manifest URL
          [
            'imeta',
            'url', 'https://cdn.divine.video/47e3747a511237274cc8d7a634970c37/manifest/video.m3u8',
    ...
    test('extracts hls URL from imeta as fallback candidate', () {
      ...
      final event = Event.fromJson({
        ...
        'tags': [
          ...
          [
            'imeta',
            'url', 'https://cdn.divine.video/broken/manifest/video.m3u8', // Broken
            'm', 'application/vnd.apple.mpegurl',
            'hls', 'https://stream.divine.video/working/playlist.m3u8', // Working
          ],
        ],
      });
    ...
    test('deprioritizes cdn.divine.video manifest URLs', () {
      final event = Event.fromJson({
        ...
        'tags': [
          ...
          [
            'imeta',
            'url', 'https://cdn.divine.video/someid/manifest/video.m3u8',
            'm', 'application/vnd.apple.mpegurl',
          ],
    ...
    test('collects URLs from streaming, fallback, mp4, video keys in imeta', () {
      final event = Event.fromJson({
        'id': 'test-postels',
        ...
        'tags': [
          ...
          [
            ...
            'mp4', 'https://mp4.example.com/video.mp4',
            'video', 'https://video.example.com/play.webm',
          ],
        ],
      });
